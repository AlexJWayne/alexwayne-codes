...
const devMode = !!document.getElementById("bg-dev")
if (devMode) createGui(guiData)

canvas.width = canvas.clientWidth / (devMode ? 1 : 2)
canvas.height = canvas.clientHeight / (devMode ? 1 : 2)
